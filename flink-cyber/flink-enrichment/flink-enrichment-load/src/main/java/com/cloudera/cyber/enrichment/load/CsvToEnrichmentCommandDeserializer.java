...
public class CsvToEnrichmentCommandDeserializer extends StdDeserializer<EnrichmentCommand> {
    ...
    public static CsvReaderFormat<EnrichmentCommand> createCsvReaderFormat(EnrichmentConfig enrichmentConfig, List<String> columnNames, boolean ignoreFirstLine, String enrichmentType) {
