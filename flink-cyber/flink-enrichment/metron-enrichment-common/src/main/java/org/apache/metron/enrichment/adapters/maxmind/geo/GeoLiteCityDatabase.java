...
public enum GeoLiteCityDatabase implements MaxMindDatabase {
    ...
    String determineHdfsDirWithFallback(Map<String, Object> globalConfig, String hdfsFile,
                                        String hdfsFallbackFile) {
        ...
        if (!globalConfig.containsKey(GEO_HDFS_FILE)) {
            ...
            try {
                ...
                // Otherwise, we'll leave it as the base default (which will cause issues later,
                // but ensures logging encourages use of new database).
