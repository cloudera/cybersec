...
public enum MaxMindDbUtilities {
    ...
    /**
     * Determines if an IP is ineligible. In particular, this is used to filter
     * before querying the database, as that requires a readlock to be set.
     *
     ...
     */
    public static DatabaseReader readNewDatabase(DatabaseReader reader, String hdfsFile, InputStream is)
          throws IOException {
