...
public class EnrichmentUtils {
    ...
    public static class TypeToKey
          implements Function<String, KeyWithContext<EnrichmentKey, EnrichmentLookup.HBaseContext>> {
        ...
        public KeyWithContext<EnrichmentKey, EnrichmentLookup.HBaseContext> apply(@Nullable String enrichmentType) {
            ...
            EnrichmentLookup.HBaseContext context =
                  new EnrichmentLookup.HBaseContext(table, getColumnFamily(enrichmentType, config));
            return new KeyWithContext<>(key, context);
        }
    }

    private static final ThreadLocal<Map<Object, Map<String, String>>> typeToCFs =
          new ThreadLocal<Map<Object, Map<String, String>>>() {
              @Override
