...
public class LookupJobWideTest extends LookupJobWide {
    ...
    @Test
    @Ignore("Appendable tables not working")
    public void testWideLookup() throws Exception {
        ...
        results.add(sink.poll(Duration.ofMillis(100000)));
        results.add(sink.poll(Duration.ofMillis(10000)));
