...
public class EnrichmentConfig implements Serializable {
    public static final String ENRICHMENT_CONFIG_MISSING_STORAGE_ERROR =
          "EnrichmentConfig %s: references undefined storage %s.";
    ...
    public void validate(String enrichmentType, Map<String, EnrichmentStorageConfig> storageConfigs) {
        Preconditions.checkState(storage == null || storageConfigs.containsKey(storage),
              String.format(ENRICHMENT_CONFIG_MISSING_STORAGE_ERROR, enrichmentType, storage));
