...
public class HbaseEnrichmentCommandSink extends AbstractHbaseSinkFunction<EnrichmentCommand> {
    public HbaseEnrichmentCommandSink(String hbaseTableName, EnrichmentsConfig enrichmentsConfig, ParameterTool params) {
        super(hbaseTableName, new HbaseEnrichmentMutationConverter(enrichmentsConfig), params, "numEnrichmentsWritten");
    }
}
