...
public class IpAsnTestData {
    ...
    public static final Map<String, Map<String, String>> ipToAsnEnrichments = new HashMap<String, Map<String, String>>() {{
        put(IP_WITH_NUMBER_AND_ORG, ImmutableMap.of(ASN_NUMBER_PREFIX, "1221",
                                         ASN_ORG_PREFIX, "Telstra Pty Ltd",
                                         ASN_MASK_PREFIX, "1.128.0.0/11"));
        put(IP_V6_WITH_NUMBER_AND_ORG, ImmutableMap.of(ASN_NUMBER_PREFIX, "6730",
                ASN_ORG_PREFIX, "Sunrise Communications AG",
                ASN_MASK_PREFIX, "2001:1700:0:0:0:0:0:0/27"));
        put(IP_NOT_FOUND, Collections.emptyMap());
    }};
