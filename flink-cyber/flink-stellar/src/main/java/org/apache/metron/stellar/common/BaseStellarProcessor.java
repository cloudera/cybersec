...
public class BaseStellarProcessor<T> {
     ...
     */
    private static final Cache<String, StellarCompiler.Expression> defaultExpressionCache;
     ...
     * @param throwException If true an invalid Stellar transformation will throw a {@link ParseException}
     *                       otherwise a boolean will be returned.
