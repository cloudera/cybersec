...
public class ClasspathFunctionResolver extends BaseFunctionResolver {
    ...
    public void include(String... toInclude) {
        Collections.addAll(includes, toInclude);
    }
    ...
    public void exclude(String... toExclude) {
        Collections.addAll(excludes, toExclude);
    }
    ...
    public void initialize(Context context) {
        ...
        if (context != null) {
            ...
            if (optional.isPresent()) {
                ...
                try {
                    vfsLoader =
                          VFSClassloaderUtil.configureClassloader(STELLAR_VFS_PATHS.get(stellarConfig, String.class));
