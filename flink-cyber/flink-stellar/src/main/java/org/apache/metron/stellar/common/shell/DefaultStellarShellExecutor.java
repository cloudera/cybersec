...
public class DefaultStellarShellExecutor implements StellarShellExecutor {
     ...
     */
    private final Map<String, VariableResult> variables;
     ...
     */
    private final Optional<CuratorFramework> zkClient;

    /**
     * A registry of all special commands; like %magic, ?doc, and quit.
     */
    private final List<SpecialCommand> specials;
     ...
     */
    private final List<FunctionDefinedListener> functionListeners;

    /**
     * Listeners that are notified when a variable is defined.
     */
    private final List<VariableDefinedListener> variableListeners;

    /**
     * Listeners that are notified when a special command is defined.
     */
    private final List<SpecialDefinedListener> specialListeners;
    ...
    /**
     * Gets Stellar config from global config.
     *
