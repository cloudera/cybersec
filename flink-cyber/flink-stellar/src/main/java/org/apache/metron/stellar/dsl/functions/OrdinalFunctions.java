...
public class OrdinalFunctions {
    ...
    @Stellar(name = "MAX",
          ...
          params = {
                ...
                "list - List of arguments. The list may only contain objects that are "
                    + "mutually comparable / ordinal (implement java.lang.Comparable interface)"
                    + " Multi type numeric comparisons are supported: MAX([10,15L,15.3]) would return 15.3, "
                    + "but MAX(['23',25]) will fail and return null as strings and numbers can't be compared."
          },
            ...
            try {
                ...
                if (convertedRet == null && ret != null) {
                    throw new IllegalStateException("Incomparable objects were submitted to " + funcName
                                                    + ": " + ret.getClass() + " is incomparable to "
                                                    + value.getClass());
                }
