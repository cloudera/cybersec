...
public class Constants {
    ...
    public enum Fields implements Field {
        ...
        PROTOCOL("protocol"), TIMESTAMP("timestamp"), ORIGINAL("original_string"), GUID("guid"),
        SENSOR_TYPE("source.type"), INCLUDES_REVERSE_TRAFFIC("includes_reverse_traffic");
        private static final Map<String, Fields> nameToField;
    ...
    public enum ErrorFields {
        MESSAGE("message"), FAILED_SENSOR_TYPE("failed_sensor_type"), ERROR_TYPE("error_type"), EXCEPTION("exception"),
        STACK("stack"), TIMESTAMP("timestamp"), HOSTNAME("hostname"), RAW_MESSAGE("raw_message"),
        RAW_MESSAGE_BYTES("raw_message_bytes"), ERROR_FIELDS("error_fields"), ERROR_HASH("error_hash"),
        METADATA("metadata");
    ...
    public enum ErrorType {
        ...
        PARSER_ERROR("parser_error"), PARSER_INVALID("parser_invalid"), ENRICHMENT_ERROR("enrichments_error"),
        THREAT_INTEL_ERROR("threatintel_error"), INDEXING_ERROR("indexing_error"), DEFAULT_ERROR("error");
