...
public abstract class BaseFunctionResolver implements FunctionResolver, Serializable {
     ...
     */
    private final Supplier<Map<String, StellarFunctionInfo>> functions;
    ...
    public BaseFunctionResolver() {
        ...
        functions =
              Suppliers.memoize((Supplier<Map<String, StellarFunctionInfo>> & Serializable) this::resolveFunctions);
        closed = false;
    }
