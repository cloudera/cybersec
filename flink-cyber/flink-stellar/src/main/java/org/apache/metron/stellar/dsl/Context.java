...
public class Context implements Serializable {
    ...
    public enum Capabilities {
        ...
        SHELL_VARIABLES,
        /**
         * This capability indicates that the StellarProcessor should use a Caffeine cache to cache expression -{@literal >} results.
         * If an expression is in the cache, then the cached result will be returned instead of recomputing.
         */
        CACHE,
        /**
    ...
    private static final ThreadLocal<ActivityType> _activityType = ThreadLocal.withInitial(() ->
          null);
