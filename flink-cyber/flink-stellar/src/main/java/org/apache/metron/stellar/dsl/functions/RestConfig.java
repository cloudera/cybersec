...
public class RestConfig extends HashMap<String, Object> {
     ...
     */
    public static final String STELLAR_REST_SETTINGS = "stellar.rest.settings";

    /**
     * A global config prefix used for storing Stellar REST GET settings.
     */
    public static final String STELLAR_REST_GET_SETTINGS = "stellar.rest.get.settings";

    /**
     * A global config prefix used for storing Stellar REST POST settings.
     */
    public static final String STELLAR_REST_POST_SETTINGS = "stellar.rest.post.settings";

    /**
     * User name for basic authentication.
     */
    public static final String BASIC_AUTH_USER = "basic.auth.user";

    /**
     * Path to the basic authentication password file stored in HDFS.
     */
    public static final String BASIC_AUTH_PASSWORD_PATH = "basic.auth.password.path";
     ...
     */
    public static final String PROXY_BASIC_AUTH_USER = "proxy.basic.auth.user";

    /**
     * Path to the proxy basic authentication password file stored in HDFS.
     */
    public static final String PROXY_BASIC_AUTH_PASSWORD_PATH = "proxy.basic.auth.password.path";
     ...
     */
    public static final String RESPONSE_CODES_ALLOWED = "response.codes.allowed";

    /**
     * The default value that will be returned on a successful request with empty content.  Default is null.
     */
    public static final String EMPTY_CONTENT_OVERRIDE = "empty.content.override";

    /**
     * The default value that will be returned on an error.  Default is null.
     */
    public static final String ERROR_VALUE_OVERRIDE = "error.value.override";

    /**
     * The maximum number of connections in the connection pool.
     */
    public static final String POOLING_MAX_TOTAL = "pooling.max.total";

    /**
     * The default maximum number of connections per route in the connection pool.
     */
    public static final String POOLING_DEFAULT_MAX_PER_RUOTE = "pooling.default.max.per.route";

    /**
     * Setting this to true will verify the actual body content length equals the content length header.
     */
    public static final String VERIFY_CONTENT_LENGTH = "verify.content.length";

    /**
     * Setting this to true will verify POST data is well-formed JSON.
     */
    public static final String ENFORCE_JSON = "enforce.json";
