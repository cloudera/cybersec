...
public class SerDeUtils {
    ...
    private static final ThreadLocal<Kryo> kryo = new ThreadLocal<Kryo>() {
        ...
        protected Kryo initialValue() {
            ...
            ret.register(Collections.singletonList("").getClass(), new ArraysAsListSerializer());
     ...
     */
    private static class DefaultInstantiatorStrategy implements org.objenesis.strategy.InstantiatorStrategy {
        ...
        @Override
        @SuppressWarnings({"unchecked", "checkstyle:EmptyCatchBlock"})
