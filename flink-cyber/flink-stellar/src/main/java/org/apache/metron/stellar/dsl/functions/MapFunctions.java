...
public class MapFunctions {
    ...
    @Stellar(name = "GET",
          ...
          returns = "The object associated with the key in the map.  "
                    + "If no value is associated with the key and default is specified, then default is returned. "
    ...
    @Stellar(name = "PUT",
          ...
          returns = "The original map modified with the key/value. "
                    + "If the map argument is null, a new map will be created "
                    + "and returned that contains the provided key and value - note: "
                    + "if the 'map' argument is null, only the returned map will be non-null and contain the key/value."
    )
