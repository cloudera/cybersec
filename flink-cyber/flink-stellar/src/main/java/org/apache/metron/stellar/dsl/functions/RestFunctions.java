...
public class RestFunctions {
    ...
    public static class RestGet implements StellarFunction {
        ...
        public Object apply(List<Object> args, Context context) throws ParseException {
            ...
            Map<String, Object> globalRestConfig =
                  (Map<String, Object>) getGlobalConfig(context).get(STELLAR_REST_SETTINGS);
            Map<String, Object> getRestConfig =
                  (Map<String, Object>) getGlobalConfig(context).get(STELLAR_REST_GET_SETTINGS);
    ...
    public static class RestPost implements StellarFunction {
        ...
        public Object apply(List<Object> args, Context context) throws ParseException {
            ...
            Map<String, Object> globalRestConfig =
                  (Map<String, Object>) getGlobalConfig(context).get(STELLAR_REST_SETTINGS);
            Map<String, Object> postRestConfig =
                  (Map<String, Object>) getGlobalConfig(context).get(STELLAR_REST_POST_SETTINGS);
        ...
        private HttpPost buildPostRequest(RestConfig restConfig, String uriString, Object dataObject,
                ...
                if (restConfig.enforceJson()) {
                    try {
                        ...
                        throw new IllegalArgumentException(
                              String.format("POST data '%s' must be properly formatted JSON.  "
                                            + "Set the '%s' property to false to disable this check.", data,
                                    RestConfig.ENFORCE_JSON));
                    }
                }
            }
            return data;
    ...
    public static <T> T getArg(int index, Class<T> clazz, List<Object> args) {
        ...
        if (index >= args.size()) {
            throw new IllegalArgumentException(
                  format("Expected at least %d argument(s), found %d", index + 1, args.size()));
        }
     ...
     *
     */
    protected static HttpClientContext getHttpClientContext(RestConfig restConfig, HttpHost target,
                                                            Optional<HttpHost> proxy) throws IOException {
        ...
        if (restConfig.getBasicAuthUser() != null && restConfig.getBasicAuthPasswordPath() != null) {
            String password =
                  new String(readBytes(new Path(restConfig.getBasicAuthPasswordPath())), StandardCharsets.UTF_8);
        ...
        if (proxy.isPresent() && restConfig.getProxyBasicAuthUser() != null
            ...
            String password =
                  new String(readBytes(new Path(restConfig.getProxyBasicAuthPasswordPath())), StandardCharsets.UTF_8);
            credentialsProvider.setCredentials(
    ...
    protected static Object executeRequest(RestConfig restConfig, HttpRequestBase httpRequestBase) throws IOException {
        ...
        ScheduledFuture scheduledFuture =
              scheduledExecutorService.schedule(httpRequestBase::abort, restConfig.getTimeout(), TimeUnit.MILLISECONDS);
        ...
        try {
            ...
            if (httpRequestBase.isAborted()) {
                throw new IOException(
                      String.format("Total Stellar REST request time to %s exceeded the configured timeout of %d ms.",
     ...
     *
     */
    protected static Optional<Object> parseResponse(RestConfig restConfig, HttpUriRequest httpUriRequest,
        ...
        if (httpEntity != null) {
            ...
            if (restConfig.verifyContentLength() && actualContentLength != httpEntity.getContentLength()) {
                throw new IOException(
                      String.format("Stellar REST request to %s returned incorrect or missing content length. "
