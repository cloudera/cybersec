...
public class StellarShell extends AeshConsoleCallback implements Completion {
    ...
    static final String WELCOME = "Stellar, Go!\n"
                                  + "Functions are loading lazily in the background and "
                                  + "will be unavailable until loaded fully.";

    private static final List<TerminalCharacter> EXPRESSION_PROMPT = new ArrayList<TerminalCharacter>() {
        {
     ...
     */
    private final StellarShellExecutor executor;
     ...
     */
    private final StellarAutoCompleter autoCompleter;
    ...
    /**
     * Getter for valid command line options.
     *
