...
public class ReflectiveParserBuilder implements ParserBuilder {
    private static final Logger logger = LogManager.getLogger(ReflectiveParserBuilder.class);
    ...
    private void invokeMethod(Parser parser,
        ...
        logger.info("Invoking method {}({}); key={}, parser={}", method.getName(), methodArgs, configKey, parser.getClass().getName());
