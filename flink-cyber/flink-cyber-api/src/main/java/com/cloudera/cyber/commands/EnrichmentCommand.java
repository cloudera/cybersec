...
public class EnrichmentCommand extends Command<EnrichmentEntry> implements HasHeaders {
    ...
    public abstract static class EnrichmentCommandBuilder<C extends EnrichmentCommand, B extends EnrichmentCommandBuilder<C, B>>
          extends CommandBuilder<EnrichmentEntry, C, B> {
    ...
    private static final class EnrichmentCommandBuilderImpl
          extends EnrichmentCommandBuilder<EnrichmentCommand, EnrichmentCommandBuilderImpl> {
