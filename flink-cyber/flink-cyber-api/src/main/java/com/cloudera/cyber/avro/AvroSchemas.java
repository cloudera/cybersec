...
public class AvroSchemas {
    ...
    public static SchemaBuilder.RecordBuilder<org.apache.avro.Schema> createRecordBuilder(String namespace,
                                                                                          String recordName) {
    ...
    public static SchemaBuilder.RecordBuilder<org.apache.avro.Schema> createRecordBuilder(String namespace,
                                                                                          String recordName,
                                                                                          String tsFieldName) {
        SchemaBuilder.RecordBuilder<org.apache.avro.Schema> recordBuilder =
              SchemaBuilder.record(recordName).namespace(namespace);
        if (tsFieldName != null) {
            recordBuilder
