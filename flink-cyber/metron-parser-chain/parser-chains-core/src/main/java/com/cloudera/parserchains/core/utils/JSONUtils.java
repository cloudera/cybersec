...
@SuppressWarnings({"checkstyle:InvalidJavadocPosition", "checkstyle:RegexpSinglelineJava"})
public enum JSONUtils {
    ...
    public static final ReferenceSupplier<Map<String, Object>> MAP_SUPPLIER =
          new ReferenceSupplier<Map<String, Object>>() {
          };
    public static final ReferenceSupplier<List<Object>> LIST_SUPPLIER = new ReferenceSupplier<List<Object>>() {
    };

    private static final ThreadLocal<ObjectMapper> _mapper = ThreadLocal.withInitial(() ->
          new ObjectMapper()
