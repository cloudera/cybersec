...
public class ClusterController {
    ...
    public ResponseBody startPipeline(
        ...
        return clusterService.startPipelineJob(clusterId, name, body.getBranch(), body.getProfileName(),
              body.getParserName(), body.getJobs(), payload.getBytes());
    }
    ...
    public ResponseBody startPipelineGit(
        ...
        return clusterService.startPipelineJob(clusterId, name, body.getBranch(), body.getProfileName(),
              body.getParserName(), body.getJobs(), ArchiveUtil.compressToTarGzInMemory(
                    Utils.getRepoFiles(body.getGitUrl(), body.getBranch(), body.getUserName(), body.getPassword())));
    }
