...
public class JobController {
    ...
    @PostMapping("/{action}")
    public ResponseBody executeAction(
          @Parameter(name = "requestBody", description = "The new parser chain definition.", required = true)
          ...
          @Schema(name = "action", description = "Jobs action for start stop restart Job", allowableValues = {
                JobActions.Constants.START_VALUE, JobActions.Constants.RESTART_VALUE, JobActions.Constants.STOP_VALUE,
                JobActions.Constants.STATUS_VALUE, JobActions.Constants.GET_CONFIG_VALUE,
                JobActions.Constants.UPDATE_CONFIG_VALUE}, required = true)
    ...
    public ResponseBody updateJobConfig(
          @Parameter(name = "clusterId", description = "The ID of the cluster to update config on.", required = true)
          @PathVariable("clusterId") String clusterId,
          @Schema(name = "pipeline", description = "Pipeline in which the job is running", allowableValues = {
                JobActions.Constants.START_VALUE, JobActions.Constants.RESTART_VALUE, JobActions.Constants.STOP_VALUE,
                JobActions.Constants.STATUS_VALUE, JobActions.Constants.GET_CONFIG_VALUE,
                JobActions.Constants.UPDATE_CONFIG_VALUE}, required = true)
          @PathVariable("pipeline") String pipeline,
          @Schema(name = "jobIdHex", description = "Job ID to update config of", allowableValues = {
                JobActions.Constants.START_VALUE, JobActions.Constants.RESTART_VALUE, JobActions.Constants.STOP_VALUE,
                JobActions.Constants.STATUS_VALUE, JobActions.Constants.GET_CONFIG_VALUE,
                JobActions.Constants.UPDATE_CONFIG_VALUE}, required = true)
