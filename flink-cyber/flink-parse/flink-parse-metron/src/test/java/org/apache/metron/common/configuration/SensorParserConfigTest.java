...
public class SensorParserConfigTest {
  ...
  public void testSerDe() throws IOException {
    for(File parserConfig : new File(getPath("/parsers")).listFiles()) {
  ...
  private String getPath(String configUri) {
    return MetronCompatibilityParser.class.getResource(configUri).getPath();
  }
}
