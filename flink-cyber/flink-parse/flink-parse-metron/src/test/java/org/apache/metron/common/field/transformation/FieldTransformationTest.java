...
public class FieldTransformationTest {
 ...
 /**
  ...
  public void testValidSerde_simple() throws IOException {
    SensorParserConfig c = SensorParserConfig.fromBytes(TestUtils.toBytes(config));
  ...
  public void testInValidSerde_missingMapping() {
    assertThrows(IllegalStateException.class, () -> SensorParserConfig.fromBytes(TestUtils.toBytes(badConfigMissingMapping)));
  }

  @Test
  public void testComplexMapping() throws IOException {
    SensorParserConfig c = SensorParserConfig.fromBytes(TestUtils.toBytes(complexConfig));
