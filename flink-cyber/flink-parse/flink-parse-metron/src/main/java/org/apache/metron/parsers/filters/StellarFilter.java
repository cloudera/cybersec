...
public class StellarFilter implements MessageFilter<JSONObject> {
    ...
    private final StellarPredicateProcessor processor = new StellarPredicateProcessor();
    private String query;
    private final FunctionResolver functionResolver = StellarFunctions.FUNCTION_RESOLVER();
