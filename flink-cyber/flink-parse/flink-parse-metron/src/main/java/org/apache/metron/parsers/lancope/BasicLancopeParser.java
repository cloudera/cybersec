...
public class BasicLancopeParser extends BasicParser {
    ...
    // 2014-07-17T15:58:30Z 10.40.10.254 0.0.0.0 Minor High Concern Index
    // The host's concern index has either exceeded the CI threshold or rapidly increased.
    // Observed 36.55M points. Policy maximum allows up to 20M points.","@version":"1",
    // "@timestamp":"2014-07-17T15:56:05.992Z","type":"syslog","host":"10.122.196.201"}
    ...
    public List<JSONObject> parse(byte[] msg) {
        ...
        try {
            ...
            String rawMessage = new String(msg, getReadCharset());

            payload = (JSONObject) JSONValue.parse(rawMessage);
            ...
            String fixedDate = parts[5].replace('T', ' ');
            fixedDate = fixedDate.replace('Z', ' ').trim();
