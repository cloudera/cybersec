...
public class ISEParser implements Serializable, ISEParserConstants {
 // private boolean nativeNumbers = false;
  ...
  /**
	...
	*/
  public JSONMapObject parseObject() throws ParseException
  {
    JSONMapObject toReturn = object();
...
final public JSONMapObject innerMap() throws ParseException {
  final JSONMapObject json = new JSONMapObject();
  String key;
  Object value;
    key = objectKey();
...
final public JSONMapObject object() throws ParseException {
  final JSONMapObject json = new JSONMapObject();
  String key;
  Object value;
    key = objectKey();
