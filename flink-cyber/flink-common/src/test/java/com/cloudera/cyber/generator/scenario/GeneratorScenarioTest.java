...
public class GeneratorScenarioTest {
    ...
    public void testCsvScenario() throws IOException {
        ...
        Map<String, String> expectedValue1 =
              ImmutableMap.of(IP_DEST_ADDR, "1.1.1.1", DOMAIN_NAME, "www.google.com", ACTION, "CONNECT");
        Map<String, String> expectedValue2 =
              ImmutableMap.of(IP_DEST_ADDR, "2.2.2.2", DOMAIN_NAME, "www.amazon.com", ACTION, "MISS");
        ...
        for (int i = 0; i < count; i++) {
            ...
            Assert.assertTrue(String.format("randomParameters = %s does not match expected values", randomParameters),
                  expectedValues.contains(randomParameters));
