...
public class TimestampNormalizer implements Function<String, Object> {
    private final List<SimpleDateFormat> possibleTimestampFormats;
    private final SimpleDateFormat normalizedFormat;
    ...
    public Object apply(String fieldValue) {
        ...
        if (parsedDate != null) {
            ...
            throw new IllegalStateException(String.format(
                  "Field value '%s' can't be normalized to a timestamp because it does not match any configured format.",
                  fieldValue));
        }
    }
