...
import * as fromActions from './parsers.actions';
import { ChainDetailsModel } from './parsers.models';
import { getChainPageState } from './parsers.reducers';
import { denormalizeParserConfig, normalizeParserConfig } from './parsers.utils';
import { CustomFormConfig } from './components/custom-form/custom-form.component';

@Injectable()
export class ParsersPageEffects {
  constructor(
