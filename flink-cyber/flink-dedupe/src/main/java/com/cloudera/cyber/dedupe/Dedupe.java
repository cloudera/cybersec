...
public class Dedupe {
    public static SingleOutputStreamOperator<DedupeMessage> dedupe(DataStream<Message> source, List<String> sessionKey,
                                                                   Long maxTime, Long maxCount,
                                                                   OutputTag<DedupeMessage> lateData,
