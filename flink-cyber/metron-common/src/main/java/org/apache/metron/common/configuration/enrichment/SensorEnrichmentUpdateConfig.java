...
public class SensorEnrichmentUpdateConfig {
    ...
    public interface SourceConfigHandler {
    ...
    public static void updateSensorConfigs(SourceConfigHandler scHandler,
                                           Map<String, FieldList> sensorToFieldList) throws Exception {
        ...
        for (Map.Entry<String, FieldList> kv : sensorToFieldList.entrySet()) {
            ...
            {
                for (Map.Entry<String, List<String>> fieldToType : kv.getValue().getFieldToEnrichmentTypes()
                                                                     .entrySet()) {
    ...
    private static SensorEnrichmentConfig findConfigBySensorType(SourceConfigHandler scHandler,
                                                                 Map<String, SensorEnrichmentConfig> sourceConfigsChanged,
