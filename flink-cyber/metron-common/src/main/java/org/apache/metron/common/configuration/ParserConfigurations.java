...
public class ParserConfigurations extends Configurations {
    ...
    public Map<String, SensorParserGroup> getSensorParserGroups() {
        ...
        Collection<SensorParserGroup> sensorParserGroups =
              JSONUtils.INSTANCE.getMapper()
                                .convertValue(groups,
                                      new TypeReference<Collection<SensorParserGroup>>() {});
        return sensorParserGroups.stream()
                                 .collect(Collectors.toMap(SensorParserGroup::getName,
