...
public class EnrichmentConfig {
    ...
    private final Map<String, ConfigHandler> enrichmentConfigs = new HashMap<>();
    ...
    public boolean equals(Object o) {
        ...
        if (getFieldMap() != null ? !getFieldMap().equals(that.getFieldMap()) : that.getFieldMap() != null) {
            return false;
        }
        if (getFieldToTypeMap() != null ? !getFieldToTypeMap().equals(that.getFieldToTypeMap())
              : that.getFieldToTypeMap() != null) {
            return false;
        }
