...
public class Configurations implements Serializable {
    ...
    public Map<String, Object> getGlobalConfig(boolean emptyMapOnNonExistent) {
        return (Map<String, Object>) getConfigurations().getOrDefault(ConfigurationType.GLOBAL.getTypeName(),
    ...
    public void updateGlobalConfig(byte[] data) throws IOException {
        if (data == null) {
            throw new IllegalStateException("global config data cannot be null");
        }
    ...
    public boolean equals(Object o) {
        ...
        return getConfigurations() != null ? getConfigurations().equals(that.getConfigurations())
              : that.getConfigurations() == null;
