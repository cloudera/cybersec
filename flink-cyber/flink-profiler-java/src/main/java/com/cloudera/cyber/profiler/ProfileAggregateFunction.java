...
@AllArgsConstructor
public abstract class ProfileAggregateFunction
      implements AggregateFunction<ProfileMessage, ProfileGroupAcc, ProfileMessage> {
    ...
    public ProfileMessage getResult(ProfileGroupAcc profileAccumulator) {
        Map<String, String> extensions =
              profileAccumulator.getProfileExtensions(profileGroupConfig, measurementFormats);
