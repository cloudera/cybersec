...
public class ProfileUtils {
    ...
    public static boolean measurementCompare(MeasurementDto measurementDto1, MeasurementDto measurementDto2) {
        ...
        return Objects.equals(measurementDto1.getFieldName(), measurementDto2.getFieldName()) && Objects.equals(measurementDto1.getResultExtensionName(), measurementDto2.getResultExtensionName()) && Objects.equals(measurementDto1.getAggregationMethod(), measurementDto2.getAggregationMethod()) && Objects.equals(measurementDto1.getFormat(),
            measurementDto2.getFormat()) && Utils.timeCompare(measurementDto1.getFirstSeenExpirationDuration(), measurementDto1.getFirstSeenExpirationDurationUnit(), measurementDto2.getFirstSeenExpirationDuration(), measurementDto2.getFirstSeenExpirationDurationUnit());
    }
